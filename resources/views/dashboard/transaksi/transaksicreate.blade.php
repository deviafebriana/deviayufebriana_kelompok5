...
@section('konten')
    ...
    <form action="{{route('transaksi.store')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text"
              class="form-control form-control-sm" name="jumlah_stok" id="jumlah_stok" aria-describedby="helpId" placeholder="jumlah_stok" value="{{Session::get('jumlah_stok')}}">
        </div>
        <div class="mb-3">
            <label for="jumlah_display" class="form-label">Jumlah Display</label>
            <input type="text"
              class="form-control form-control-sm" name="jumlah_display" id="jumlah_display" aria-describedby="helpId" placeholder="jumlah_display" value="{{Session::get('jumlah_display')}}">
        </div>
        <div class="mb-3">
            <label for="visit_datetime" class="form-label">Time Visit</label>
            <input type="date"
              class="form-control form-control-sm" name="visit_datetime" id="visit_datetime" aria-describedby="helpId" placeholder="visit_datetime" value="{{Session::get('visit_datetime')}}">
        </div>
