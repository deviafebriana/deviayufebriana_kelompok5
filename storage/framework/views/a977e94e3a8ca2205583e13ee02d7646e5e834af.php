...
<?php $__env->startSection('konten'); ?>
    ...
    <form action="<?php echo e(route('outlet.store')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" rows="5" name="alamat_outlet"><?php echo e(Session::get('alamat_outlet')); ?></textarea>
        </div>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugas_fullstack\resources\views/dashboard/outlet/outletcreate.blade.php ENDPATH**/ ?>