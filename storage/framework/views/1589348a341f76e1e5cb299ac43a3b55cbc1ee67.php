...
<?php $__env->startSection('konten'); ?>
    ...
    <form action="<?php echo e(route('sales.update', $data->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text"
              class="form-control form-control-sm" name="lokasi_sales" id="lokasi_sales" aria-describedby="helpId" placeholder="lokasi_sales" value="<?php echo e($data->lokasi_sales); ?>">
        </div>
        <div class="mb-3">
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugas_fullstack\resources\views/dashboard/sales/salesedit.blade.php ENDPATH**/ ?>